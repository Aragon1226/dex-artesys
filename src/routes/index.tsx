...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://dex.xn--artsys-dva.com/" },
      { property: "og:image", content: "https://dex.xn--artsys-dva.com/og-artesys.jpg" },
      ...
      { name: "twitter:image", content: "https://dex.xn--artsys-dva.com/og-artesys.jpg" },
    ],
    links: [{ rel: "canonical", href: "https://dex.xn--artsys-dva.com/" }],
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          "@type": "Organization",
          name: "Artesys",
          url: "https://dex.xn--artsys-dva.com/",
          logo: "https://dex.xn--artsys-dva.com/icons/icon-512x512.png",
          description:
