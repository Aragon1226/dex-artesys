...
const AdminSupport = () => {
  ...
  const handleSave = async (e: React.FormEvent) => {
    ...
    if (!emailLower.endsWith("@artesys.com")) {
      setError(
        "Support email must strictly belong to the @artesys.com domain (e.g. xxxxxxxx@artesys.com)",
      );
      setSaving(false);
      return;
    }
    ...
    <div className="p-6 lg:p-8 max-w-4xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-sm text-muted-foreground mt-1">
          Manage contact channels for customer support.
        </p>
      </div>
              ...
              <div className="col-span-1 md:col-span-2">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="pl-10 w-full border border-border rounded-lg p-2.5 bg-card text-foreground focus:ring-2 focus:ring-ring outline-none"
                    placeholder="support@artesys.com"
                  />
                </div>
                <p className="text-xs text-muted-foreground mt-1">
                  Direct email inquiries will be sent here.
                </p>
              </div>
              <div>
