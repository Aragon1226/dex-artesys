    ...
    <div className="p-6 lg:p-8 h-[calc(100vh-4rem)] flex flex-col">
      <div className="mb-6">
        ...
        <p className="text-sm text-muted-foreground mt-1">
          Live support terminal for user inquiries.
        </p>
      </div>
                  ...
                  <div className="flex-1 p-6 overflow-y-auto space-y-4">
                    {messages.map((m) => {
                      ...
                      return (
                        ...
                        >
                          <div
                            className={`max-w-[70%] rounded-2xl p-3 ${m.sender_type === "admin" ? "bg-primary text-primary-foreground rounded-tr-none" : "bg-muted text-foreground rounded-tl-none"}`}
                          >
                            {isImage ? (
