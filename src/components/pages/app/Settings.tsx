...
export const Settings = ({ initialTab: propInitialTab }: SettingsProps) => {
  ...
  const [userDeleteReason, setUserDeleteReason] = useState(
    "No longer using the simulation platform",
  );
  ...
  useEffect(() => {
    ...
    if (tabFromUrl && ["overview", "terms", "policies", "faq"].includes(tabFromUrl)) {
      ...
      propInitialTab &&
      ["overview", "terms", "policies", "faq"].includes(propInitialTab)
    ) {
  ...
  const headings: Record<string, { title: string; subtitle: string }> = {
    ...
    terms: {
      ...
      subtitle:
        "The rules that govern your use of the Artesys platform, accounts and simulated trading features.",
    },
    policies: {
    ...
    <div className="min-h-screen bg-background text-foreground pb-20 pt-6 px-4 sm:px-6 lg:px-8">
      <div className="max-w-5xl mx-auto space-y-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 border-b border-border/80 pb-6">
          <div className="space-y-1">
            ...
            <p className="text-xs sm:text-sm text-muted-foreground pl-10">{pageHeading.subtitle}</p>
          </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="space-y-1">
              ...
              <p className="text-xs text-warning/80 leading-relaxed">
                Artesys operates exclusively as an educational simulation platform. All trades,
                portfolio values, and yield rates are simulated paper figures for learning purposes.
                No real financial services or advice are provided.
              </p>
            </div>
          </div>
        </div>
              ...
              <div className="flex items-center gap-3 border-b border-border pb-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">
                    Manage your session preferences, security settings, and legal disclosures.
                  </p>
                </div>
              </div>
                ...
                <div className="p-5 rounded-2xl bg-muted/40 border border-border flex flex-col justify-between space-y-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground">
                        TLS Encrypted Session & Auth Protection
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div className="space-y-1">
                      ...
                      <p className="text-xs text-muted-foreground leading-relaxed max-w-xl">
                        Permanently purge your account, profile credentials, simulated trading
            ...
            <div className="flex items-center justify-between border-b border-border pb-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">
                    Effective Date: April 2026 | Educational Platform Standard
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-6 text-sm text-muted-foreground leading-relaxed">
              <section className="bg-primary/5 p-4 rounded-2xl border border-primary/10 text-foreground">
                ...
                <p className="text-xs sm:text-sm text-muted-foreground leading-relaxed">
                  Artesys is explicitly designed and provided for{" "}
                  <strong>
                    demo trading, market simulation, technical learning, and educational purposes
                  </strong>{" "}
                  within the computer science and educational sector. The platform does NOT provide
                  real-money trading, financial brokerage, asset custody, or monetary investment
                  opportunities. All currency values (USDT, BTC, ETH, etc.) inside the app are paper
              ...
              <section className="space-y-2">
                <h4 className="font-bold text-foreground text-base">
                  2. User Agreement & Eligibility
                </h4>
                <p>
                  By creating an account or using Artesys, you acknowledge that you are using a
                  simulation tool. You confirm that you understand no financial claims, withdrawal
                  guarantees, or real money earnings exist. You must be legally capable of agreeing
                  to software testing terms in your jurisdiction.
                </p>
              </section>

              <section className="space-y-2">
                <h4 className="font-bold text-foreground text-base">
                  3. Simulated Trading & Yield Disclaimer
                </h4>
                <p>
                  All order book executions, spot swaps, futures leverage positions, and staking
                  yield figures displayed on the platform are software-calculated models designed to
                  illustrate market mechanics. Past simulated performance inside Artesys does not
                  correlate to real-world financial market outcomes.
                </p>
              </section>

              <section className="space-y-2">
                <h4 className="font-bold text-foreground text-base">
                  4. Platform Features Transparency
                </h4>
                <p>
                  Features such as Market Data, Spot Trading, Futures Leverage, Earn Staking, KYC
                  Verification, and User Support are provided solely as integrated software modules
                  to simulate a complete crypto trading ecosystem for educational review and
                  application testing.
                </p>
              </section>
              ...
              <section className="space-y-2">
                <h4 className="font-bold text-foreground text-base">
                  5. Account Registration & User Security
                </h4>
                <p>
                  Users are responsible for keeping their login credentials confidential. While
                  Artesys implements security protocols, users acknowledge that accounts are
                  maintained for software interaction and progress tracking within the educational
                  environment.
                </p>
              </section>
              ...
              <section className="space-y-2">
                <h4 className="font-bold text-foreground text-base">
                  6. Developer & Operators Exemption of Liability
                </h4>
                <p>
                  To the maximum extent permitted by law, the development team, individual software
                  engineers, project contributors, and platform operators hold ZERO legal liability,
                  financial responsibility, or obligation for any loss, misunderstanding, or
                  consequence arising from user interaction with this app.
                </p>
              </section>
              ...
              <section className="space-y-2">
                ...
                <p>
                  We reserve the right to modify these terms at any time to preserve transparency
                  and comply with software standards or app store policies.
                </p>
              </section>
            </div>
          </div>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-border pb-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">
                    Transparent breakdown of every feature, tool, and policy inside Artesys.
                  </p>
                </div>
              </div>
            ...
            <div className="space-y-8">
              {filteredFaqs.length === 0 ? (
                <p className="text-center text-sm text-muted-foreground py-8">
                  No questions found matching "{faqSearch}". Try searching for terms like
                  "educational", "trading", "deposit", or "developer".
                </p>
              ) : (
                  ...
                  <div key={idx} className="space-y-3">
                    ...
                    <div className="space-y-3">
                      {cat.questions.map((faq, fIdx) => (
                        <details
                          key={fIdx}
                          className="group bg-muted/30 rounded-2xl border border-border overflow-hidden transition-colors hover:border-primary/30"
                        >
                          <summary className="flex items-center justify-between p-4 cursor-pointer list-none font-bold text-sm text-foreground">
                            <span className="pr-4">{faq.q}</span>
                            <ChevronRight
                              size={16}
                              className="text-muted-foreground shrink-0 transition-transform group-open:rotate-90 group-open:text-primary"
                            />
                          </summary>
      ...
      {isDeleteModalOpen && (
        <div className="fixed inset-0 z-50 bg-black/60 flex items-center justify-center p-4 backdrop-blur-sm animate-fade-in">
          <form
            onSubmit={handleUserAccountDelete}
            className="bg-card w-full max-w-md rounded-[28px] p-6 shadow-2xl relative border border-rose-500/20 animate-scale-in"
          >
            <button
              type="button"
              aria-label="Close"
            ...
            <div className="space-y-4 mb-6">
              <div className="p-4 rounded-2xl bg-muted/40 border border-border text-xs space-y-2">
                ...
                <p className="text-muted-foreground leading-relaxed pt-2 border-t border-border/40">
                  This action is{" "}
                  <strong className="text-rose-400 font-bold">permanent and irreversible</strong>.
                  All your simulated spot and futures balances, order book history,
                  deposit/withdrawal records, and preferences will be permanently wiped.
                </p>
              </div>
              ...
              <div>
                ...
                >
                  <option value="Completed demo trading curriculum">
                    Completed demo trading curriculum
                  </option>
                  <option value="No longer using the simulation platform">
                    No longer using the simulation platform
                  </option>
                  <option value="Switching to a different training environment">
                    Switching to a different training environment
                  </option>
                  <option value="Privacy & data minimization preference">
              ...
              <div>
                <label className="block text-xs font-bold text-foreground mb-1.5">
                  ...
                  <span className="font-mono text-rose-500 font-bold">DELETE</span> below:
                </label>
                <input
                  type="text"
                  required
