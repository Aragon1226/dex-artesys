    ...
    try {
      ...
      if (data.status === "ok") {
        return data.items.map((item: any, index: number) => {
          ...
          const isBadFeedImage =
            !feedImage ||
            feedImage.length < 10 ||
            badImageUrls.some((bad) => feedImage.toLowerCase().includes(bad));
    ...
    return [
      {
        ...
        summary:
          "Major banks are finalizing multi-layered custody solutions as enterprise interest in blockchain settlements hits a new peak.",
        url: "#",
      ...
      },
      {
        ...
        summary:
          "The G20's latest stance on cross-border stablecoin settlements has initiated a wave of institutional risk reassessments.",
        url: "#",
        source: "Bloomberg",
        timestamp: "12m ago",
        imageUrl:
          "https://images.unsplash.com/photo-1611974715853-2bfa4e030612?auto=format&fit=crop&q=80&w=800",
      },
    ];
  },
};
