...
const SEED_BASELINE_LOGS: SystemActivityLogEntry[] = [
  ...
  },
  {
    ...
    details:
      "Approved 2,500.00 USDT deposit request for user alex.vanguard@tradingcorp.io (TxID: 0x8a92...e41c).",
    severity: "success",
    metadata: {
      amount: 2500,
      symbol: "USDT",
  ...
  },
  {
    ...
    details:
      "Approved withdrawal of 0.45000000 BTC to bc1q9d7a22m4k01lp9... for user elena.rostova@fintech.net.",
    severity: "success",
    metadata: {
      amount: 0.45,
      symbol: "BTC",
  ...
  },
  {
    ...
    details:
      "Configured new TRC20 receiving address: TLaJ8bW7VpNm47dK3xXyZ9QrtP82o1uY6C for global deposits.",
    severity: "info",
    metadata: {
      symbol: "USDT",
      network: "TRC20",
  ...
  },
  {
    ...
    details:
      "Updated official contact channels: Email: support@artesys.com | Telegram: @ArtesysOfficialSupport | WhatsApp: +44 7451 289910.",
    severity: "info",
    metadata: {
  ...
  },
  {
    ...
    details:
      "Set algorithmic execution outcome to FORCE_WIN for VIP institutional test trader (marcus.k@quantumalpha.ch).",
    severity: "warning",
    metadata: {
      userId: "user_892014",
  ...
  },
  {
    ...
    details:
      "Declined withdrawal of 3.20000000 ETH for user trial.account99@gmail.com. Reason: Security verification check pending.",
    severity: "danger",
    metadata: {
      amount: 3.2,
      symbol: "ETH",
  ...
  },
  {
    ...
    details:
      "Manual return to base price ($123.50) initiated for BOT token from idle price $148.20 over 2.4 hours gradual recovery.",
    severity: "info",
    metadata: {
      symbol: "BOT",
      startPrice: 148.2,
...
export const recordActivityLog = (
  entry: Omit<SystemActivityLogEntry, "id" | "timestamp" | "adminEmail"> & {
    timestamp?: string;
