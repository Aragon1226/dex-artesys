...
export const MAJOR_SYMBOLS = [
  "BTC", "ETH", "BNB", "SOL", "XRP", "ADA", "LINK", "DOT",
  "AVAX", "MATIC", "DOGE", "SHIB", "PEPE", "WIF", "NEAR", "APT",
  "UNI", "AAVE", "MKR", "CRV", "LDO",
  "AXS", "SAND", "MANA", "IMX", "APE",
  "SUI", "SEI", "FTM", "OP", "ARB", "POL", "TRX", "LTC",
  "ETC", "BCH", "ATOM", "ALGO", "HBAR", "VET",
  "FET", "RENDER", "WLD", "GRT",
  "BONK", "FLOKI", "BOME", "POPCAT", "MEME", "BRETT",
  "FTT", "LUNC", "USTC", "ALPHA", "TRU", "UNFI", "GAS",
  "LOOM", "PHB", "KEY", "REEF", "LINA", "JASMY", "GALA",
  "CHZ", "FIL", "ICP",
];
...
const LAYER1 = ["SOL", "AVAX", "NEAR", "APT", "ADA", "DOT", "SUI", "SEI", "FTM", "OP", "ARB", "POL", "TRX", "LTC", "ETC", "BCH", "ATOM", "ALGO", "HBAR", "VET"];
const LAYER2 = ["OP", "ARB", "NAS", "AEP", "ECB", "BOT", "TTZS", "OCT", "CFR", "STC", "CFT", "RTV", "JOE", "REO", "BEX", "RYR", "OAS", "JTC"];
const MEME = ["DOGE", "SHIB", "PEPE", "WIF", "BONK", "FLOKI", "BOME", "POPCAT", "MEME", "BRETT"];
const DEFI = ["UNI", "AAVE", "MKR", "CRV", "LDO", "FET", "RENDER", "WLD", "GRT", "JASMY", "GALA", "CHZ", "FIL", "ICP", "FTT", "LUNC", "USTC", "ALPHA", "TRU", "UNFI", "GAS", "LOOM", "PHB", "KEY", "REEF", "LINA"];
...
const NAMES: Record<string, string> = {
  ...
  ADA: "Cardano", LINK: "Chainlink", DOT: "Polkadot", AVAX: "Avalanche",
  MATIC: "Polygon (MATIC)", POL: "Polygon", DOGE: "Dogecoin", SHIB: "Shiba Inu",
  PEPE: "Pepe", WIF: "dogwifhat", NEAR: "NEAR Protocol", APT: "Aptos",
  UNI: "Uniswap", AAVE: "Aave", MKR: "Maker", CRV: "Curve DAO", LDO: "Lido DAO",
  AXS: "Axie Infinity", SAND: "The Sandbox", MANA: "Decentraland",
  IMX: "Immutable", APE: "ApeCoin", SUI: "Sui", SEI: "Sei", FTM: "Fantom",
  OP: "Optimism", ARB: "Arbitrum", TRX: "TRON", LTC: "Litecoin",
  ETC: "Ethereum Classic", BCH: "Bitcoin Cash", ATOM: "Cosmos", ALGO: "Algorand",
  HBAR: "Hedera", VET: "VeChain", FET: "Artificial Superintelligence Alliance",
  RENDER: "Render", WLD: "Worldcoin", GRT: "The Graph", BONK: "Bonk",
  FLOKI: "Floki", BOME: "Book of Meme", POPCAT: "Popcat", MEME: "Memecoin",
  BRETT: "Brett", FTT: "FTX Token", LUNC: "Terra Classic", USTC: "TerraClassicUSD",
  ALPHA: "Alpha Venture DAO", TRU: "TrueFi", UNFI: "Unifi Protocol",
  GAS: "Gas", LOOM: "Loom Network", PHB: "Phoenix", KEY: "SelfKey",
  REEF: "Reef", LINA: "Linear Finance", JASMY: "JasmyCoin", GALA: "Gala",
  CHZ: "Chiliz", FIL: "Filecoin", ICP: "Internet Computer",

  AAPL: "Apple", TSLA: "Tesla", NVDA: "NVIDIA", AMZN: "Amazon",
  MSFT: "Microsoft", GOOGL: "Alphabet", META: "Meta Platforms",
  NFLX: "Netflix", AMD: "AMD", COIN: "Coinbase", MSTR: "MicroStrategy",
  SPY: "S&P 500 Index", VIX: "Volatility Index", GOLD: "Gold",
  SILVER: "Silver", OIL: "Crude Oil",
};
